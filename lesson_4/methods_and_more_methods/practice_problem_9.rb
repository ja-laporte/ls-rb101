...
# ---My Solution---
# a new array with the return value of the block. => ['bear']
...
# Second, where did that nil come from? If we look at the if condition 
# (value.size > 3), we'll notice that it evaluates to true when the length of 
# value is greater than 3. 

# In this case, the only value with a length greater 
